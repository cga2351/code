  ...
  implements Serializable
{
  ...
  {
    if (this == paramObject);
    HttpClientWrapper localHttpClientWrapper;
    do
    {
      return true;
      if ((paramObject == null) || (getClass() != paramObject.getClass()))
        return false;
      localHttpClientWrapper = (HttpClientWrapper)paramObject;
      if (!this.http.equals(localHttpClientWrapper.http))
        return false;
      if (!this.requestHeaders.equals(localHttpClientWrapper.requestHeaders))
        return false;
    }
    while (this.wrapperConf.equals(localHttpClientWrapper.wrapperConf));
    return false;
  }
