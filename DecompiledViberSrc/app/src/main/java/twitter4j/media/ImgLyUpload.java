...
{
  public ImgLyUpload(Configuration paramConfiguration, OAuthAuthorization paramOAuthAuthorization)
  {
    ...
    throws TwitterException
  {
    ...
    {
      throw new TwitterException("Invalid ImgLy response: " + str1, localJSONException);
    }
 ...
 * Qualified Name:     twitter4j.media.ImgLyUpload
