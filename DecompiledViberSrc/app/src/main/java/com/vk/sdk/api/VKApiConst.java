...
public class VKApiConst
{
  ...
  static enum VKProgressType
  {
    static
    {
      VKProgressTypeDownload = new VKProgressType("VKProgressTypeDownload", 1);
      VKProgressType[] arrayOfVKProgressType = new VKProgressType[2];
      arrayOfVKProgressType[0] = VKProgressTypeUpload;
      arrayOfVKProgressType[1] = VKProgressTypeDownload;
    }
  }
}

/* Location:           E:\Study\Tools\apktool2_2\dex2jar-0.0.9.15\classes_viber_4_dex2jar.jar
 * Qualified Name:     com.vk.sdk.api.VKApiConst
