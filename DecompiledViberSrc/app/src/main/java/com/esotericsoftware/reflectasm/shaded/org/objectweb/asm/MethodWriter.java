...
class MethodWriter extends MethodVisitor
{
  ...
  private void b(Frame paramFrame)
  {
    ...
    {
      int i12 = arrayOfInt2[i4];
      i5++;
      if ((i12 == 16777220) || (i12 == 16777219))
        i4++;
      i4++;
    }
    a(paramFrame.b.c, i2, i5);
    int i6 = 0;
    int i7;
    while (true)
    {
  ...
  private void d()
  {
    ...
    {
      i41 = 0xFF & arrayOfByte1[i3];
      i42 = 0;
      switch (ClassWriter.a[i41])
      {
      case 16:
      default:
        i3 += 4;
      ...
      case 4:
        while (i42 != 0)
        {
          ...
          arrayOfInt2[localObject2.length] = i42;
          if (i42 <= 0)
            break label2011;
          i2 = 3;
      ...
      case 9:
        if (i41 > 201)
          ...
          {
            i50 = i41 - 49;
            int i51 = i3 + c(arrayOfByte1, i3 + 1);
            i41 = i50;
            i47 = i51;
            int i48 = a((int[])localObject1, (int[])localObject2, i3, i47);
            if (((i48 >= -32768) && (i48 <= 32767)) || (arrayOfBoolean[i3] != 0))
              break label2020;
            if ((i41 != 167) && (i41 != 168))
              break label384;
            i49 = 2;
    ...
    while (true)
    {
      ...
      break label163;
      if (i2 == 1)
        i42 = -(0x3 & a((int[])localObject1, (int[])localObject2, 0, i3));
      while (true)
      {
        int i46 = i3 + 4 - (i3 & 0x3);
        i3 = i46 + (12 + 4 * (1 + (a(arrayOfByte1, i46 + 8) - a(arrayOfByte1, i46 + 4))));
        break;
        int i45 = arrayOfBoolean[i3];
        i42 = 0;
        if (i45 == 0)
        {
          i42 = i3 & 0x3;
      ...
      {
        int i44 = i3 + 4 - (i3 & 0x3);
        i3 = i44 + (8 + 8 * a(arrayOfByte1, i44 + 4));
        break;
        int i43 = arrayOfBoolean[i3];
        i42 = 0;
        if (i43 == 0)
        {
          i42 = i3 & 0x3;
      ...
      if (i2 == 0)
      {
        ...
        while (true)
        {
          label837: label858: label1023: int i19;
          if (i4 < this.r.b)
          {
            int i13 = 0xFF & arrayOfByte1[i4];
            ...
            case 9:
              ...
              if (i13 > 201)
                ...
                {
                  i39 = i13 - 49;
                  int i40 = i4 + c(arrayOfByte1, i4 + 1);
                  i13 = i39;
                  i35 = i40;
                  i36 = a((int[])localObject1, (int[])localObject2, i4, i35);
              ...
              while (true)
              {
                ...
                if (i13 <= 166);
                for (int i37 = -1 + (0x1 ^ i13 + 1); ; i37 = i13 ^ 0x1)
                {
                  localByteVector1.putByte(i37);
                ...
                localByteVector1.putByte(i13);
                localByteVector1.putShort(i36);
              }
            case 10:
              int i34 = a((int[])localObject1, (int[])localObject2, i4, i4 + a(arrayOfByte1, i4 + 1));
              localByteVector1.putByte(i13);
              localByteVector1.putInt(i34);
              i4 += 5;
              break;
            case 14:
              int i24 = i4 + 4 - (i4 & 0x3);
              ...
              int i25 = i4 + a(arrayOfByte1, i24);
              int i26 = i24 + 4;
              localByteVector1.putInt(a((int[])localObject1, (int[])localObject2, i4, i25));
              int i27 = a(arrayOfByte1, i26);
              int i28 = i26 + 4;
              localByteVector1.putInt(i27);
              int i29 = 1 + (a(arrayOfByte1, i28) - i27);
              int i30 = i28 + 4;
              localByteVector1.putInt(a(arrayOfByte1, i30 - 4));
              i19 = i30;
              int i31 = i29;
              while (i31 > 0)
              {
                int i32 = i4 + a(arrayOfByte1, i19);
                int i33 = i19 + 4;
                localByteVector1.putInt(a((int[])localObject1, (int[])localObject2, i4, i32));
                i31--;
                i19 = i33;
              }
            case 15:
              ...
              localByteVector1.putByteArray(null, 0, (4 - localByteVector1.b % 4) % 4);
              int i15 = i4 + a(arrayOfByte1, i14);
              int i16 = i14 + 4;
              localByteVector1.putInt(a((int[])localObject1, (int[])localObject2, i4, i15));
              int i17 = a(arrayOfByte1, i16);
              int i18 = i16 + 4;
              localByteVector1.putInt(i17);
              i19 = i18;
              int i20 = i17;
              while (i20 > 0)
              {
                localByteVector1.putInt(a(arrayOfByte1, i19));
                int i21 = i19 + 4;
                int i22 = i4 + a(arrayOfByte1, i21);
                int i23 = i21 + 4;
                localByteVector1.putInt(a((int[])localObject1, (int[])localObject2, i4, i22));
                i20--;
                i19 = i23;
              }
            case 17:
          ...
          else
          {
            if (this.u > 0)
            {
              if (this.M == 0)
              {
                ...
                localFrame.a(this.b, this.c, arrayOfType, this.t);
                b(localFrame);
                for (Label localLabel = this.N; localLabel != null; localLabel = localLabel.i)
                {
                  int i12 = -3 + localLabel.c;
                  if (((0x20 & localLabel.a) != 0) || ((i12 >= 0) && (arrayOfBoolean[i12] != 0)))
                  {
      ...
      i1 = i2;
      break;
      label2011: localObject2 = arrayOfInt2;
      localObject1 = arrayOfInt1;
      break label46;
      label2020: i49 = 0;
    }
  ...
  final int a()
  {
    ...
    if (this.r.b > 0)
    {
      ...
      if (i9 == 0)
        break label618;
      str = "StackMapTable";
      label238: localClassWriter.newUTF8(str);
    }
    label579: label612: label618: label763: for (i1 = i8 + (8 + this.v.b); ; i1 = i8)
    {
      if (this.J != null)
  ...
  {
    int i1 = 1;
    int i2 = 0x60000 | (0x40000 & this.c) / 64;
    ...
    for (int i3 = i1; ; i3 = 0)
    {
      ...
      label1354: for (int i6 = i5 + (8 + this.v.b); ; i6 = i5)
      {
        if (this.J != null)
        ...
        for (int i7 = i1; ; i7 = 0)
        {
          ...
          label1004: label1009: for (String str = "StackMapTable"; ; str = "StackMap")
          {
          ...
          label1017: if (((0x1000 & this.c) != 0) && (((0xFFFF & this.b.b) < 49) || ((0x40000 & this.c) != 0)))
  ...
  public void visitFrame(int paramInt1, int paramInt2, Object[] paramArrayOfObject1, int paramInt3, Object[] paramArrayOfObject2)
  {
    ...
    if (paramInt1 == -1)
    {
      ...
      if (i5 < paramInt2)
      {
        if ((paramArrayOfObject1[i5] instanceof String))
        {
          int[] arrayOfInt6 = this.z;
          int i12 = this.y;
          this.y = (i12 + 1);
          arrayOfInt6[i12] = (0x1700000 | this.b.c((String)paramArrayOfObject1[i5]));
        }
        while (true)
        {
          i5++;
          break;
          if ((paramArrayOfObject1[i5] instanceof Integer))
          {
            int[] arrayOfInt5 = this.z;
            int i11 = this.y;
            this.y = (i11 + 1);
            arrayOfInt5[i11] = ((Integer)paramArrayOfObject1[i5]).intValue();
          }
          else
          {
            int[] arrayOfInt4 = this.z;
            int i10 = this.y;
            this.y = (i10 + 1);
            arrayOfInt4[i10] = (0x1800000 | this.b.a("", ((Label)paramArrayOfObject1[i5]).c));
          }
        }
      }
      if (i6 < paramInt3)
      {
        if ((paramArrayOfObject2[i6] instanceof String))
        {
          int[] arrayOfInt3 = this.z;
          int i9 = this.y;
          this.y = (i9 + 1);
          arrayOfInt3[i9] = (0x1700000 | this.b.c((String)paramArrayOfObject2[i6]));
        }
        while (true)
        {
          i6++;
          break;
          if ((paramArrayOfObject2[i6] instanceof Integer))
          {
            int[] arrayOfInt2 = this.z;
            int i8 = this.y;
            this.y = (i8 + 1);
            arrayOfInt2[i8] = ((Integer)paramArrayOfObject2[i6]).intValue();
          }
          else
          {
            ...
            int i7 = this.y;
            this.y = (i7 + 1);
            arrayOfInt1[i7] = (0x1800000 | this.b.a("", ((Label)paramArrayOfObject2[i6]).c));
          }
        }
      }
      b();
      label379: this.s = Math.max(this.s, paramInt3);
  ...
  public void visitInsn(int paramInt)
  {
    ...
    while (true)
    {
      if (((paramInt >= 172) && (paramInt <= 177)) || (paramInt == 191))
        e();
      return;
      label63: int i1 = this.Q + Frame.a[paramInt];
      if (i1 > this.R)
        this.R = i1;
      this.Q = i1;
    }
  ...
  public void visitJumpInsn(int paramInt, Label paramLabel)
  {
    ...
    if (((0x2 & paramLabel.a) != 0) && (paramLabel.c - this.r.b < -32768))
      ...
      {
        this.r.putByte(200);
        label122: paramLabel.a(this, this.r, -1 + this.r.b, true);
      }
    while (true)
    {
      if (this.P != null)
      ...
      while (true)
      {
        ...
        while (localLabel9 != null)
        {
          ...
          if ((0x40 & localLabel9.a) == 0)
          {
            ...
            int i12 = this.y;
            this.y = (i12 + 1);
            arrayOfInt[i12] = (0x1700000 | this.b.c("java/lang/Throwable"));
            b();
            this.B = Handler.a(this.B, localLabel9, localLabel10);
          }
          label602: localLabel9 = localLabel9.i;
        }
        ...
        while (true)
        {
          ...
          while (true)
          {
            ...
            if (localEdge2 != null)
            {
              ...
              {
                i4 = 1;
                label1109: localLabel1.f = i4;
                localLabel1.a = (0x8 | localLabel1.a);
                localLabel1.k = ((Label)localObject2);
              }
            }
            label1200: for (Object localObject3 = localLabel1; ; localObject3 = localObject2)
            {
        ...
        label1221: localObject6 = localObject5;
      }
      label1228: i13 = i6;
    }
  }
  ...
  public void visitMethodInsn(int paramInt, String paramString1, String paramString2, String paramString3)
  {
    ...
    {
      localItem = this.b.a(paramString1, paramString2, paramString3, bool);
      i1 = localItem.c;
      if (this.P != null)
      {
        if (this.M != 0)
      ...
      localItem.c = i2;
      label88: this.r.b(185, localItem.a).a(i2 >> 2, 0);
      return;
    }
    int i3;
    if (i1 == 0)
    {
      i3 = Type.getArgumentsAndReturnSizes(paramString3);
      localItem.c = i3;
    }
    while (true)
    {
      if (paramInt == 184);
      for (int i4 = 1 + (this.Q - (i3 >> 2) + (i3 & 0x3)); ; i4 = this.Q - (i3 >> 2) + (i3 & 0x3))
      {
        if (i4 > this.R)
          this.R = i4;
        this.Q = i4;
      ...
      label210: this.r.b(paramInt, localItem.a);
      return;
      label225: i2 = i1;
      break label88;
      i3 = i1;
  ...
  public void visitVarInsn(int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      this.Q = i3;
      break;
      label234: i2 = paramInt2 + 1;
      break label65;
      label242: i1 = paramInt2 + (59 + (paramInt1 - 54 << 2));
      break label111;
      label258: if (paramInt2 >= 256)
 ...
 * Qualified Name:     com.esotericsoftware.reflectasm.shaded.org.objectweb.asm.MethodWriter
