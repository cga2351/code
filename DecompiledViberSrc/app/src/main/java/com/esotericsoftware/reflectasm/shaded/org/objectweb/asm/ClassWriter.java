...
public class ClassWriter extends ClassVisitor
{
    ...
    while (true)
    {
      ...
      for (int i6 = i10; ; i6 = i4)
      {
        ...
        if (this.r != null)
        {
          ...
          localByteVector.putByteArray(this.r.a, 2, i9);
        }
        if (this.s != 0)
        {
  ...
  public final void visitInnerClass(String paramString1, String paramString2, String paramString3, int paramInt)
  {
    ...
    int i1;
    int i2;
    label62: ByteVector localByteVector3;
    int i3;
    if (paramString1 == null)
    {
      i1 = 0;
      localByteVector1.putShort(i1);
      ByteVector localByteVector2 = this.y;
      if (paramString2 != null)
        break label112;
      i2 = 0;
      localByteVector2.putShort(i2);
      localByteVector3 = this.y;
      i3 = 0;
      if (paramString3 != null)
        break label122;
    }
    while (true)
    {
      localByteVector3.putShort(i3);
      this.y.putShort(paramInt);
      return;
      i1 = newClass(paramString1);
      break;
      label112: i2 = newClass(paramString2);
      break label62;
      label122: i3 = newUTF8(paramString3);
    }
  }
