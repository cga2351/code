...
{
  public static final a a = new a("306", bn.a());
  ...
  static
  {
    ...
    b = localSparseArray;
    localSparseArray.put(1, new a("100", "1.00"));
    ...
    b.put(59, new a("274", "2.74"));
    b.put(60, new a("275", "2.75"));
    b.put(61, new a("276", "2.76"));
    b.put(62, new a("277", "2.77"));
    b.put(63, new a("278", "2.78"));
    b.put(64, new a("280", "2.80"));
    b.put(65, new a("281", "2.81-RC1"));
    b.put(66, new a("300", "3.0.0"));
    b.put(67, new a("301", "3.1.0"));
    b.put(68, new a("302", "3.2.0"));
    b.put(69, new a("303", "3.2.1"));
    b.put(70, new a("304", "3.2.2"));
    b.put(71, new a("305", "3.3.0"));
    b.put(72, new a("306", "3.4.0"));
  }
 ...
 * Qualified Name:     com.yandex.metrica.impl.bm
