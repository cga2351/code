...
public class b extends ai
{
  protected String a(String[] paramArrayOfString, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localStringBuilder.append(" FROM blockednumbers LEFT OUTER JOIN vibernumbers ON (vibernumbers.member_id=blockednumbers.canonized_number) LEFT OUTER JOIN phonebookdata ON (vibernumbers.canonized_number=phonebookdata.data2 OR blockednumbers.canonized_number=phonebookdata.data2) LEFT OUTER JOIN phonebookcontact ON (phonebookdata.contact_id=phonebookcontact._id) ");
 ...
 * Qualified Name:     com.viber.voip.s.a.b
