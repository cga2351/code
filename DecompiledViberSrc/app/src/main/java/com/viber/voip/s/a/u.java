...
public class u extends ai
{
  protected String a(String[] paramArrayOfString, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localStringBuilder.append(" FROM conversations LEFT OUTER JOIN public_accounts ON (conversations.group_id=public_accounts.group_id) LEFT OUTER JOIN participants_info ON (conversations.participant_id_1=participants_info._id)");
 ...
 * Qualified Name:     com.viber.voip.s.a.u
