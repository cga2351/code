...
public class g extends d
{
  ...
  public g(com.viber.voip.notif.h.m paramm, a<b> parama, af paramaf, String paramString)
  {
    super(paramm);
    this.h = parama;
    this.i = paramaf;
  ...
  private CharSequence i(Context paramContext)
  {
    if (com.viber.voip.messages.m.a(this.i, this.j))
    {
      ...
      for (int n = R.string.message_notification_you_removed_as_superadmin; ; n = R.string.message_notification_you_removed_as_admin)
        return paramContext.getString(n);
    }
    String str = a(this.i, this.h, paramContext, this.j, this.a.e().j(), this.a.e().p());
    if (com.viber.voip.messages.m.b(this.a.c().getConversationType()));
    for (int m = R.string.message_notification_removed_as_superadmin; ; m = R.string.message_notification_removed_as_admin)
 ...
 * Qualified Name:     com.viber.voip.notif.b.f.d.g
