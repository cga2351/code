  ...
  implements f
{
  ...
  public q(View paramView)
  {
    ...
    this.r = ((TextView)paramView.findViewById(R.id.translateMessageView));
    this.s = ((TextView)paramView.findViewById(R.id.translateByView));
  }
 ...
 * Qualified Name:     com.viber.voip.messages.conversation.adapter.c.q
