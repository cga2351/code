  ...
  implements f
{
  ...
  public ap(View paramView)
  {
    ...
    this.p = ((TextView)paramView.findViewById(R.id.videoInfoView));
    this.q = ((TextView)paramView.findViewById(R.id.timebombView));
  }
 ...
 * Qualified Name:     com.viber.voip.messages.conversation.adapter.c.ap
