  ...
  implements f
{
  ...
  public r(View paramView)
  {
    ...
    this.r = ((TextView)paramView.findViewById(R.id.textMessageView));
    this.s = ((PlayableImageView)paramView.findViewById(R.id.progressView));
    this.t = ((TextView)paramView.findViewById(R.id.videoInfoView));
    this.u = ((ImageView)paramView.findViewById(R.id.forwardView));
  }
 ...
 * Qualified Name:     com.viber.voip.messages.conversation.adapter.c.r
