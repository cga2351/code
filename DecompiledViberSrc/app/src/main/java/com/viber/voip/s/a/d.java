...
public class d extends ai
{
  protected String a(String[] paramArrayOfString, String paramString1, String paramString2, String paramString3, String paramString4)
  {
    ...
    localStringBuilder.append(" FROM ").append("messages").append(" LEFT JOIN ").append("participants_info").append(" ON ").append("participants_info").append(".").append("member_id").append(" = ").append("messages").append(".").append("user_id");
 ...
 * Qualified Name:     com.viber.voip.s.a.d
