...
public class DiskCacheConfig
{
  ...
  private DiskCacheConfig(Builder paramBuilder)
  {
    ...
    {
      localObject1 = NoOpCacheErrorLogger.getInstance();
      this.mCacheErrorLogger = ((CacheErrorLogger)localObject1);
      if (paramBuilder.mCacheEventListener != null)
        break label153;
      localObject2 = NoOpCacheEventListener.getInstance();
      label105: this.mCacheEventListener = ((CacheEventListener)localObject2);
      if (paramBuilder.mDiskTrimmableRegistry != null)
        break label161;
    }
    label153: label161: for (Object localObject3 = NoOpDiskTrimmableRegistry.getInstance(); ; localObject3 = paramBuilder.mDiskTrimmableRegistry)
    {
      this.mDiskTrimmableRegistry = ((DiskTrimmableRegistry)localObject3);
      this.mContext = paramBuilder.mContext;
      this.mIndexPopulateAtStartupEnabled = paramBuilder.mIndexPopulateAtStartupEnabled;
      return;
      localObject1 = paramBuilder.mCacheErrorLogger;
      break;
      localObject2 = paramBuilder.mCacheEventListener;
      break label105;
    }
  }
