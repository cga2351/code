...
public class ScrollEvent extends Event<ScrollEvent>
{
  ...
  {
    ScrollEvent localScrollEvent = (ScrollEvent)EVENTS_POOL.acquire();
    if (localScrollEvent == null)
      localScrollEvent = new ScrollEvent();
    localScrollEvent.init(paramInt1, paramScrollEventType, paramInt2, paramInt3, paramFloat1, paramFloat2, paramInt4, paramInt5, paramInt6, paramInt7);
    return localScrollEvent;
  }
