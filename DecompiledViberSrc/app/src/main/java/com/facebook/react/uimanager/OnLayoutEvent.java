...
public class OnLayoutEvent extends Event<OnLayoutEvent>
{
  ...
  {
    OnLayoutEvent localOnLayoutEvent = (OnLayoutEvent)EVENTS_POOL.acquire();
    if (localOnLayoutEvent == null)
      localOnLayoutEvent = new OnLayoutEvent();
    localOnLayoutEvent.init(paramInt1, paramInt2, paramInt3, paramInt4, paramInt5);
    return localOnLayoutEvent;
  }
