...
public class TouchEvent extends Event<TouchEvent>
{
  ...
  private void init(int paramInt, TouchEventType paramTouchEventType, MotionEvent paramMotionEvent, long paramLong, float paramFloat1, float paramFloat2, TouchEventCoalescingKeyHelper paramTouchEventCoalescingKeyHelper)
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      case 4:
      default:
        throw new RuntimeException("Unhandled MotionEvent action: " + i);
      case 0:
      case 1:
      case 5:
      case 6:
  ...
  {
    TouchEvent localTouchEvent = (TouchEvent)EVENTS_POOL.acquire();
    if (localTouchEvent == null)
      localTouchEvent = new TouchEvent();
    localTouchEvent.init(paramInt, paramTouchEventType, paramMotionEvent, paramLong, paramFloat1, paramFloat2, paramTouchEventCoalescingKeyHelper);
