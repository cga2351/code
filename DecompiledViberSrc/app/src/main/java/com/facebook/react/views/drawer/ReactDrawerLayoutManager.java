...
public class ReactDrawerLayoutManager extends ViewGroupManager<ReactDrawerLayout>
{
  ...
  public void setElevation(ReactDrawerLayout paramReactDrawerLayout, float paramFloat)
  {
    ...
    try
    {
      ...
      Method localMethod = ReactDrawerLayout.class.getMethod("setDrawerElevation", arrayOfClass);
      Object[] arrayOfObject = new Object[1];
      arrayOfObject[0] = Float.valueOf(PixelUtil.toPixelFromDIP(paramFloat));
      localMethod.invoke(paramReactDrawerLayout, arrayOfObject);
      return;
    }
    catch (Exception localException)
    {
      FLog.w("ReactNative", "setDrawerElevation is not available in this version of the support lib.", localException);
    }
  }
