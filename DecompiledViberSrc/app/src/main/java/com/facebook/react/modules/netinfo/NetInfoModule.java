  ...
  implements LifecycleEventListener
{
  ...
  private void updateAndSendConnectionType()
  {
    ...
    try
    {
      ...
      while (true)
      {
        String str3 = getCurrentConnectionType();
        if ((!str2.equalsIgnoreCase(this.mConnectionType)) || (!str1.equalsIgnoreCase(this.mEffectiveConnectionType)) || (!str3.equalsIgnoreCase(this.mConnectivityDeprecated)))
        {
          this.mConnectionType = str2;
          this.mEffectiveConnectionType = str1;
          this.mConnectivityDeprecated = str3;
        ...
        case 4:
          str2 = "cellular";
          str1 = getEffectiveConnectionType(localNetworkInfo);
          break;
        case 6:
          str2 = "wimax";
        case 2:
