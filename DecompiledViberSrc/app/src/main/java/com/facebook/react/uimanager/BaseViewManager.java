...
public abstract class BaseViewManager<T extends View, C extends LayoutShadowNode> extends ViewManager<T, C>
{
  ...
  private static void setTransformProperty(@Nonnull View paramView, ReadableArray paramReadableArray)
  {
    ...
    {
      float f1 = (float)arrayOfDouble[2];
      if (f1 == 0.0F)
        f1 = 0.00078125F;
      float f2 = -1.0F / f1;
      float f3 = DisplayMetricsHolder.getScreenDisplayMetrics().density;
      paramView.setCameraDistance(f2 * (f3 * f3) * CAMERA_DISTANCE_NORMALIZATION_MULTIPLIER);
    }
  }

  private void updateViewAccessibility(@Nonnull T paramT)
  {
    AccessibilityDelegateUtil.setDelegate(paramT);
  }
  ...
  public void setAccessibilityComponentType(@Nonnull T paramT, String paramString)
  {
  ...
  public void setAccessibilityRole(@Nonnull T paramT, @Nullable String paramString)
  {
    if (paramString == null)
      return;
    paramT.setTag(R.id.accessibility_role, AccessibilityDelegateUtil.AccessibilityRole.fromValue(paramString));
  }
  ...
  public void setViewStates(@Nonnull T paramT, @Nullable ReadableArray paramReadableArray)
  {
    ...
    while (true)
    {
      ...
      break label17;
      break;
      label58: if (str.equals("disabled"))
  ...
  public void setZIndex(@Nonnull T paramT, float paramFloat)
  {
    ...
    ViewParent localViewParent = paramT.getParent();
    if ((localViewParent != null) && ((localViewParent instanceof ReactZIndexedViewGroup)))
      ((ReactZIndexedViewGroup)localViewParent).updateDrawingOrder();
  }
}
