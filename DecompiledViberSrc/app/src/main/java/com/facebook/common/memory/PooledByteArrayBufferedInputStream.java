...
public class PooledByteArrayBufferedInputStream extends InputStream
{
    ...
    throws IOException
  {
    ...
    int i = Math.min(this.mBufferedSize - this.mBufferOffset, paramInt2);
    System.arraycopy(this.mByteArray, this.mBufferOffset, paramArrayOfByte, paramInt1, i);
    this.mBufferOffset = (i + this.mBufferOffset);
    return i;
  }
    ...
    throws IOException
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      if (i < paramLong)
        break;
      this.mBufferOffset = ((int)(paramLong + this.mBufferOffset));
      return paramLong;
    }
