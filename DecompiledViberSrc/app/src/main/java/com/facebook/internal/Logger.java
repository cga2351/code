...
public class Logger
{
  ...
  public static void log(LoggingBehavior paramLoggingBehavior, String paramString1, String paramString2, Object[] paramArrayOfObject)
  {
    if (Settings.isLoggingBehaviorEnabled(paramLoggingBehavior))
      log(paramLoggingBehavior, 3, paramString1, String.format(paramString2, paramArrayOfObject));
  }
  ...
  {
    if (shouldLog())
      this.contents.append(String.format(paramString, paramArrayOfObject));
  }
