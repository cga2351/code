  ...
  implements Producer<EncodedImage>
{
  ...
  private void maybeStartInputProducer(Consumer<EncodedImage> paramConsumer, ProducerContext paramProducerContext)
  {
    ...
    for (Object localObject = new DiskCacheWriteConsumer(paramConsumer, paramProducerContext, this.mDefaultBufferedDiskCache, this.mSmallImageBufferedDiskCache, this.mCacheKeyFactory, null); ; localObject = paramConsumer)
    {
