  ...
  implements MediatedInterstitialAdView
{
  ...
  {
    if (a.a());
    for (String str = "com.appnexus.opensdk.mediatedviews.GooglePlayServicesInterstitial"; ; str = "com.appnexus.opensdk.mediatedviews.LegacyAdMobInterstitial")
    {
      this.a = a.b(str);
      if (this.a != null)
        break;
 ...
 * Qualified Name:     com.appnexus.opensdk.mediatedviews.AdMobInterstitial
