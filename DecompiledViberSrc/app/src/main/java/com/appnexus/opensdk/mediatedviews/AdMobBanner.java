  ...
  implements MediatedBannerAdView
{
  ...
  {
    if (a.a());
    for (String str = "com.appnexus.opensdk.mediatedviews.GooglePlayServicesBanner"; ; str = "com.appnexus.opensdk.mediatedviews.LegacyAdMobBanner")
    {
      this.a = a.a(str);
      if (this.a != null)
        break;
 ...
 * Qualified Name:     com.appnexus.opensdk.mediatedviews.AdMobBanner
