...
public final class a
{
  ...
  private static Canvas a(float paramFloat, int paramInt, Paint paramPaint, Canvas paramCanvas)
  {
    ...
    paramCanvas.drawCircle(paramInt / 2.0F, paramInt / 2.0F, paramInt / 2.0F - f / 2.0F, localPaint2);
 ...
 * Qualified Name:     com.my.target.b.e.a
