...
public final class j extends h
{
  ...
  public j(com.google.e.h paramh)
  {
    super(paramh);
  }
    ...
    while (j < 8)
    {
      for (int k = 0; k < 8; k++)
        if ((0xFF & paramArrayOfByte[(i + k)]) <= paramInt3)
          paramb.b(paramInt1 + k, paramInt2 + j);
      j++;
      i += paramInt4;
    }
  }
  ...
  private static void a(byte[] paramArrayOfByte, int paramInt1, int paramInt2, int paramInt3, int paramInt4, int[][] paramArrayOfInt, b paramb)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        a(paramArrayOfByte, i1, k, i4 / 25, paramInt3, paramb);
        m++;
        break label32;
        i++;
        break;
        ...
        label408: label422: for (int i19 = i17; ; i19 = i3)
        {
          ...
          while (true)
          {
            ...
            if (i4 - i3 <= 24)
            {
              ...
              if ((i <= 0) || (m <= 0))
                break label408;
              i7 = (arrayOfInt1[(i - 1)][m] + 2 * arrayOfInt1[i][(m - 1)] + arrayOfInt1[(i - 1)][(m - 1)]) / 4;
              if (i3 >= i7)
                break label408;
            }
            while (true)
    ...
    throws com.google.e.j
  {
    ...
    if ((i >= 40) && (j >= 40))
    {
      ...
      localb = new b(i, j);
      a(arrayOfByte, k, m, i, j, arrayOfInt, localb);
    }
 ...
 * Qualified Name:     com.google.e.c.j
