...
final class r
{
  ...
  private static final Object[][] e = arrayOfObject;4;
    ...
    throws j
  {
    ...
    for (Object[] arrayOfObject8 : b)
      if (arrayOfObject8[0].equals(str1))
      {
        if (arrayOfObject8[1] == a)
          return b(2, ((Integer)arrayOfObject8[2]).intValue(), paramString);
        return a(2, ((Integer)arrayOfObject8[1]).intValue(), paramString);
      }
    if (paramString.length() < 3)
      throw j.a();
    String str2 = paramString.substring(0, 3);
    for (Object[] arrayOfObject7 : c)
      if (arrayOfObject7[0].equals(str2))
      {
        if (arrayOfObject7[1] == a)
          return b(3, ((Integer)arrayOfObject7[2]).intValue(), paramString);
        return a(3, ((Integer)arrayOfObject7[1]).intValue(), paramString);
      }
    for (Object[] arrayOfObject6 : d)
      if (arrayOfObject6[0].equals(str2))
      {
        if (arrayOfObject6[1] == a)
          return b(4, ((Integer)arrayOfObject6[2]).intValue(), paramString);
        return a(4, ((Integer)arrayOfObject6[1]).intValue(), paramString);
      }
    if (paramString.length() < 4)
      throw j.a();
    String str3 = paramString.substring(0, 4);
    for (Object[] arrayOfObject5 : e)
      if (arrayOfObject5[0].equals(str3))
      {
        if (arrayOfObject5[1] == a)
          return b(4, ((Integer)arrayOfObject5[2]).intValue(), paramString);
        return a(4, ((Integer)arrayOfObject5[1]).intValue(), paramString);
      }
    throw j.a();
  }
 ...
 * Qualified Name:     com.google.e.f.a.a.a.r
