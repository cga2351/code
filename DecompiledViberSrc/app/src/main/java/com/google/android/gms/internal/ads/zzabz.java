...
public final class zzabz extends AbstractSafeParcelable
{
  ...
  public zzabz(SearchAdRequest paramSearchAdRequest)
  {
    this.zzckg = paramSearchAdRequest.getQuery();
  }

  @SafeParcelable.Constructor
  zzabz(@SafeParcelable.Param(id=15) String paramString)
  {
  ...
  public final void writeToParcel(Parcel paramParcel, int paramInt)
  {
    ...
    SafeParcelWriter.writeString(paramParcel, 15, this.zzckg, false);
    SafeParcelWriter.finishObjectHeader(paramParcel, i);
  }
}

/* Location:           E:\Study\Tools\apktool2_2\dex2jar-0.0.9.15\classes_viber_2_dex2jar.jar
 * Qualified Name:     com.google.android.gms.internal.ads.zzabz
