...
public abstract interface Channel extends Parcelable
{
  ...
  @Deprecated
  public static abstract interface GetInputStreamResult extends Releasable, Result
  {
    @Nullable
  ...
  @Deprecated
  public static abstract interface GetOutputStreamResult extends Releasable, Result
  {
    @Nullable
