    ...
    implements BaseImplementation.ResultHolder<R>
  {
      ...
      throws DeadObjectException
    {
      if ((paramA instanceof SimpleClientAdapter))
        paramA = ((SimpleClientAdapter)paramA).getClient();
      try
      {
        doExecute(paramA);
        return;
      ...
      {
        setFailedResult(localDeadObjectException);
        throw localDeadObjectException;
      }
      catch (RemoteException localRemoteException)
      {
        setFailedResult(localRemoteException);
      }
    }
    ...
    public final void setFailedResult(Status paramStatus)
    {
      ...
      for (boolean bool = true; ; bool = false)
      {
        ...
        Result localResult = createFailedResult(paramStatus);
        setResult(localResult);
        onSetFailedResult(localResult);
        return;
      }
    }
  }
