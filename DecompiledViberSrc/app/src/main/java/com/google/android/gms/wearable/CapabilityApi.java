...
public abstract interface CapabilityApi
{
  ...
  @Deprecated
  public static abstract interface AddLocalCapabilityResult extends Result
  {
  }
  ...
  @Deprecated
  public static abstract interface GetAllCapabilitiesResult extends Result
  {
    public abstract Map<String, CapabilityInfo> getAllCapabilities();
  }

  @Deprecated
  public static abstract interface GetCapabilityResult extends Result
  {
  ...
  @Deprecated
  public static abstract interface RemoveLocalCapabilityResult extends Result
  {
  }
}
