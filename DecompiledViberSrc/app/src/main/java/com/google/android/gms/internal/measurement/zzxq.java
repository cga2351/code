...
final class zzxq extends zzxn
{
  private static int zza(byte[] paramArrayOfByte, int paramInt1, long paramLong, int paramInt2)
  {
    ...
    return zzxl.zzd(paramInt1, zzxj.zza(paramArrayOfByte, paramLong), zzxj.zza(paramArrayOfByte, 1L + paramLong));
  }
      ...
      do
      {
        do
        {
          ...
          while (true)
            ...
            {
              long l8 = 1L + l4;
              n = zzxj.zza(paramArrayOfByte, l4);
              if (n >= 0)
              {
                m--;
                l4 = l8;
                ...
                for (long l2 = l1; ; l2 = l9)
                {
                  if (j >= i)
                    break label182;
                  l9 = 1L + l2;
                  if (zzxj.zza(paramArrayOfByte, l2) < 0)
                    break;
                  j++;
                }
                j = i;
        ...
        while (zzxj.zza(paramArrayOfByte, l4) <= -65);
        return -1;
        if (n >= -16)
          break label351;
        if (i1 < 2)
        ...
        m = i1 - 2;
        l7 = l4 + 1L;
        int i3 = zzxj.zza(paramArrayOfByte, l4);
        if ((i3 > -65) || ((n == -32) && (i3 < -96)) || ((n == -19) && (i3 >= -96)))
          break label349;
        l3 = 1L + l7;
      }
      while (zzxj.zza(paramArrayOfByte, l7) <= -65);
      return -1;
      if (i1 < 3)
        return zza(paramArrayOfByte, n, l4, i1);
      m = i1 - 3;
      long l5 = 1L + l4;
      int i2 = zzxj.zza(paramArrayOfByte, l4);
      if ((i2 > -65) || ((n << 28) + (i2 + 112) >> 30 != 0))
        break label446;
      l6 = 1L + l5;
      if (zzxj.zza(paramArrayOfByte, l5) > -65)
        break label446;
      l3 = 1L + l6;
    }
    while (zzxj.zza(paramArrayOfByte, l6) <= -65);
    label446: return -1;
  }
  ...
  final int zzb(CharSequence paramCharSequence, byte[] paramArrayOfByte, int paramInt1, int paramInt2)
  {
    ...
    while (k < i)
    {
      ...
      if (i1 >= 128)
        break;
      long l11 = 1L + l1;
      zzxj.zza(paramArrayOfByte, l1, (byte)i1);
      k++;
      l1 = l11;
    }
    if (k == i)
    ...
    while (true)
    {
      if (k < i)
      {
        ...
        {
          l7 = 1L + localObject;
          zzxj.zza(paramArrayOfByte, localObject, (byte)m);
        }
        while (true)
        {
          k++;
          ...
          {
            long l10 = l3 + 1L;
            zzxj.zza(paramArrayOfByte, l3, (byte)(0x3C0 | m >>> 6));
            l7 = 1L + l10;
            zzxj.zza(paramArrayOfByte, l10, (byte)(0x80 | m & 0x3F));
          }
          else if (((m < 55296) || (57343 < m)) && (l3 <= l2 - 3L))
          {
            long l8 = 1L + l3;
            zzxj.zza(paramArrayOfByte, l3, (byte)(0x1E0 | m >>> 12));
            long l9 = 1L + l8;
            zzxj.zza(paramArrayOfByte, l8, (byte)(0x80 | 0x3F & m >>> 6));
            l7 = 1L + l9;
            zzxj.zza(paramArrayOfByte, l9, (byte)(0x80 | m & 0x3F));
          }
          else
          {
            if (l3 > l2 - 4L)
            ...
            {
              throw new zzxp(k - 1, i);
            }
            int n = Character.toCodePoint(m, c2);
            long l4 = 1L + l3;
            zzxj.zza(paramArrayOfByte, l3, (byte)(0xF0 | n >>> 18));
            long l5 = 1L + l4;
            zzxj.zza(paramArrayOfByte, l4, (byte)(0x80 | 0x3F & n >>> 12));
            long l6 = l5 + 1L;
            zzxj.zza(paramArrayOfByte, l5, (byte)(0x80 | 0x3F & n >>> 6));
            l7 = 1L + l6;
            zzxj.zza(paramArrayOfByte, l6, (byte)(0x80 | n & 0x3F));
          }
        }
  ...
  {
    long l1 = zzxj.zzb(paramByteBuffer);
    ...
    while (true)
    {
      if (j < i)
      {
        ...
        while (true)
        {
          ...
          {
            long l11 = l4 + 1L;
            zzxj.zza(l4, (byte)(0x3C0 | k >>> 6));
            l8 = 1L + l11;
            zzxj.zza(l11, (byte)(0x80 | k & 0x3F));
          }
          else if (((k < 55296) || (57343 < k)) && (l4 <= l3 - 3L))
          {
            long l9 = 1L + l4;
            zzxj.zza(l4, (byte)(0x1E0 | k >>> 12));
            long l10 = 1L + l9;
            zzxj.zza(l9, (byte)(0x80 | 0x3F & k >>> 6));
            l8 = 1L + l10;
            zzxj.zza(l10, (byte)(0x80 | k & 0x3F));
          }
          else
          {
            if (l4 > l3 - 4L)
            ...
            {
              throw new zzxp(j - 1, i);
            }
            int m = Character.toCodePoint(k, c1);
            long l5 = 1L + l4;
            zzxj.zza(l4, (byte)(0xF0 | m >>> 18));
            long l6 = 1L + l5;
            zzxj.zza(l5, (byte)(0x80 | 0x3F & m >>> 12));
            long l7 = l6 + 1L;
            zzxj.zza(l6, (byte)(0x80 | 0x3F & m >>> 6));
            l8 = 1L + l7;
            zzxj.zza(l7, (byte)(0x80 | m & 0x3F));
          }
        }
    ...
    throws zzuv
  {
    ...
    while (k < i)
    {
      byte b9 = zzxj.zza(paramArrayOfByte, k);
      if (zzxm.zzh(b9))
      {
        k++;
        int i13 = j + 1;
        zzxm.zzb(b9, arrayOfChar, j);
        j = i13;
        continue;
        int i8 = m + 1;
        byte b7 = zzxj.zza(paramArrayOfByte, m);
        int i9 = j + 1;
        zzxm.zzb(b1, b7, arrayOfChar, j);
        j = i9;
        k = i8;
      }
    }
    while (true)
    {
      if (k >= i)
        break label469;
      m = k + 1;
      b1 = zzxj.zza(paramArrayOfByte, k);
      int i4;
      if (zzxm.zzh(b1))
      {
        int i10 = j + 1;
        zzxm.zzb(b1, arrayOfChar, j);
        i4 = i10;
        int i11;
        for (k = m; k < i; k = i11)
        {
          byte b8 = zzxj.zza(paramArrayOfByte, k);
          if (!zzxm.zzh(b8))
            break;
          i11 = k + 1;
          int i12 = i4 + 1;
          zzxm.zzb(b8, arrayOfChar, i4);
          i4 = i12;
        }
      }
      if (zzxm.zzi(b1))
      ...
      if (zzxm.zzj(b1))
      {
        if (m >= i - 1)
          throw zzuv.zzwx();
        int i5 = m + 1;
        byte b5 = zzxj.zza(paramArrayOfByte, m);
        int i6 = i5 + 1;
        byte b6 = zzxj.zza(paramArrayOfByte, i5);
        int i7 = j + 1;
        zzxm.zzb(b1, b5, b6, arrayOfChar, j);
        j = i7;
        k = i6;
      }
      else
      {
        if (m >= i - 2)
          throw zzuv.zzwx();
        int n = m + 1;
        byte b2 = zzxj.zza(paramArrayOfByte, m);
        int i1 = n + 1;
        byte b3 = zzxj.zza(paramArrayOfByte, n);
        int i2 = i1 + 1;
        byte b4 = zzxj.zza(paramArrayOfByte, i1);
        int i3 = j + 1;
        zzxm.zzb(b1, b2, b3, b4, arrayOfChar, j);
        i4 = i3 + 1;
        k = i2;
        j = i4;
      }
 ...
 * Qualified Name:     com.google.android.gms.internal.measurement.zzxq
