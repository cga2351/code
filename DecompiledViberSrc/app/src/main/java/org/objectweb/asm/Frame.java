      ...
      if (((j & 0xFF00000) == 24117248) || ((j & 0xF0000000) != 0))
      {
        ...
        if ((0xFFF00000 & k) == (0xFFF00000 & j))
          if ((j & 0xFF00000) == 24117248)
            k = 0x1700000 | 0xF0000000 & k | paramClassWriter.a(k & 0xFFFFF, 0xFFFFF & j);
      }
      while (j != k)
      {
        paramArrayOfInt[paramInt2] = k;
        return true;
        k = 0x1700000 | -268435456 + (j & 0xF0000000) | paramClassWriter.c("java/lang/Object");
        continue;
        if (((k & 0xFF00000) == 24117248) || ((k & 0xF0000000) != 0))
        {
          int m;
          label194: int n;
          if (((k & 0xF0000000) == 0) || ((k & 0xFF00000) == 24117248))
          {
            m = 0;
            n = m + (k & 0xF0000000);
            if (((j & 0xF0000000) != 0) && ((j & 0xFF00000) != 24117248))
              break label260;
          }
          label260: for (int i1 = 0; ; i1 = -268435456)
          {
            k = 0x1700000 | Math.min(n, i1 + (0xF0000000 & j)) | paramClassWriter.c("java/lang/Object");
            break;
            m = -268435456;
            break label194;
          }
        ...
        if (j == 16777221)
        {
          if (((k & 0xFF00000) != 24117248) && ((0xF0000000 & k) == 0))
            k = 16777216;
        }
        else
          k = 16777216;
 ...
 * Qualified Name:     org.objectweb.asm.Frame
