...
public class AsyncExecutor
{
  ...
  private AsyncExecutor(Executor paramExecutor, EventBus paramEventBus, Class<?> paramClass, Object paramObject)
  {
    ...
    {
      throw new RuntimeException("Failure event class must have a constructor with one parameter of type Throwable", localNoSuchMethodException);
    }
  }
 ...
 * Qualified Name:     org.greenrobot.eventbus.util.AsyncExecutor
