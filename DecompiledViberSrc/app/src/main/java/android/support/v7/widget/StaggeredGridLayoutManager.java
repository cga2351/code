  ...
  implements RecyclerView.SmoothScroller.ScrollVectorProvider
{
  ...
  private int fill(RecyclerView.Recycler paramRecycler, LayoutState paramLayoutState, RecyclerView.State paramState)
  {
    ...
    int i2;
    int i3;
    label137: Span localSpan2;
    label158: Span localSpan1;
    label173: label194: int i13;
    label227: int i6;
    int i5;
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        break;
        label507: j = this.mPrimaryOrientation.getStartAfterPadding();
        break label62;
        label519: i3 = 0;
        break label137;
        label525: localSpan2 = getNextSpan(paramLayoutState);
        break label158;
        label535: localSpan1 = this.mSpans[i2];
        break label173;
        label547: addView(localView, 0);
        break label194;
        label557: i13 = localSpan1.getEndLine(j);
        break label227;
        label569: if (localLayoutParams.mFullSpan);
        for (int i4 = getMinStart(j); ; i4 = localSpan1.getStartLine(j))
        {
        ...
        label737: break label314;
        label739: i11 = this.mSecondaryOrientation.getEndAfterPadding() - (-1 + this.mSpanCount - localSpan1.mIndex) * this.mSizePerSpan;
        break label355;
        label769: if (localLayoutParams.mFullSpan);
        for (int i7 = this.mSecondaryOrientation.getStartAfterPadding(); ; i7 = localSpan1.mIndex * this.mSizePerSpan + this.mSecondaryOrientation.getStartAfterPadding())
        {
          i8 = i7 + this.mSecondaryOrientation.getDecoratedMeasurement(localView);
          i9 = i7;
          break;
        }
        label830: layoutDecoratedWithMargins(localView, i5, i9, i6, i8);
        break label395;
        label847: int i10 = this.mLayoutState.mLayoutDirection;
        updateRemainingSpans(localSpan1, i10, i);
        break label416;
        label869: this.mRemainingSpans.set(localSpan1.mIndex, false);
      }
      label885: if (k == 0)
  ...
  private Span getNextSpan(LayoutState paramLayoutState)
  {
    ...
    for (Object localObject3 = localSpan2; ; localObject3 = localObject1)
    {
      ...
      k = 0;
      break;
      label118: int m = this.mPrimaryOrientation.getEndAfterPadding();
      int n = k;
      int i1 = -2147483648;
      Span localSpan1;
      int i2;
  ...
  private void handleUpdate(int paramInt1, int paramInt2, int paramInt3)
  {
    ...
    if (this.mShouldReverseLayout)
    {
      ...
      j = paramInt2 + 1;
      k = paramInt1;
      label32: this.mLazySpanLookup.invalidateAfter(k);
      switch (paramInt3)
      {
      default:
        label76: if (j > i)
  ...
  private void onLayoutChildren(RecyclerView.Recycler paramRecycler, RecyclerView.State paramState, boolean paramBoolean)
  {
    ...
    while (true)
    {
      ...
      i = 0;
      break;
      label244: resolveShouldLayoutReverse();
      localAnchorInfo.mLayoutFromEnd = this.mShouldReverseLayout;
    }
    label260: label323: label454: int k;
    if ((i != 0) || (this.mAnchorInfo.mSpanReferenceLines == null))
    {
      ...
      fill(paramRecycler, this.mLayoutState, paramState);
      label422: repositionToWrapContentIfNecessary();
      if (getChildCount() > 0)
      {
        if (!this.mShouldReverseLayout)
          break label673;
    ...
    label673: label690: label696: for (int j = 1; ; j = 0)
    {
      ...
      break label323;
      label618: setLayoutStateDirection(1);
      fill(paramRecycler, this.mLayoutState, paramState);
      setLayoutStateDirection(-1);
      this.mLayoutState.mCurrentPosition = (localAnchorInfo.mPosition + this.mLayoutState.mItemDirection);
      fill(paramRecycler, this.mLayoutState, paramState);
  ...
  private void repositionToWrapContentIfNecessary()
  {
    ...
    label165: label329: for (float f3 = 1.0F * f2 / this.mSpanCount; ; f3 = f2)
    {
      f4 = Math.max(f1, f3);
      break label57;
      ...
      while (true)
      {
        ...
        break label165;
        break;
        label203: if ((isLayoutRTL()) && (this.mOrientation == 1))
        {
  ...
  private void updateLayoutState(int paramInt, RecyclerView.State paramState)
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        ...
        bool3 = false;
        break;
        label181: j = this.mPrimaryOrientation.getTotalSpace();
        i = 0;
        break label68;
  ...
  boolean areAllEndsEqual()
  {
    ...
    for (int k = i; ; k++)
      ...
      {
        if (this.mSpans[k].getEndLine(-2147483648) != j)
          i = 0;
      }
      else
        return i;
  ...
  boolean areAllStartsEqual()
  {
    ...
    for (int k = i; ; k++)
      if (k < this.mSpanCount)
      {
        if (this.mSpans[k].getStartLine(-2147483648) != j)
          i = 0;
      }
      else
        return i;
  ...
  View hasGapsToFix()
  {
    ...
    label128: label138: for (int m = 1; ; m = -1)
    {
      n = i;
      if (n == k)
        break label356;
    ...
    label144: localBitSet.clear(localLayoutParams1.mSpan.mIndex);
    label156: if (localLayoutParams1.mFullSpan);
    label282: label350: label354: label356: label358: label362: 
    while (true)
    {
      n += m;
      break;
  ...
  public View onFocusSearchFailed(View paramView, int paramInt, RecyclerView.Recycler paramRecycler, RecyclerView.State paramState)
  {
    ...
    for (int j = getLastChildPosition(); ; j = getFirstChildPosition())
    {
      ...
      if (bool1)
        break;
      View localView7 = localSpan.getFocusableViewAfter(j, i);
    ...
    if (preferLastSpan(i))
      ...
      {
        View localView6 = this.mSpans[i7].getFocusableViewAfter(j, i);
        if ((localView6 != null) && (localView6 != localView1))
          return localView6;
      }
    for (int k = 0; k < this.mSpanCount; k++)
    {
      View localView5 = this.mSpans[k].getFocusableViewAfter(j, i);
    ...
    int i2;
    int i4;
    label434: label440: label446: for (int i6 = localSpan.findFirstPartiallyVisibleItemPosition(); ; i6 = localSpan.findLastPartiallyVisibleItemPosition())
    {
    ...
    i2++;
    label514: if (i2 < this.mSpanCount)
    {
      if (i1 != 0);
  ...
  public Parcelable onSaveInstanceState()
  {
    ...
    while (true)
    {
      ...
      break;
      label220: i = getFirstChildPosition();
      break label118;
      label228: k = this.mSpans[j].getStartLine(-2147483648);
      if (k != -2147483648)
        k -= this.mPrimaryOrientation.getStartAfterPadding();
    }
    label263: localSavedState.mAnchorPosition = -1;
    localSavedState.mVisibleAnchorPosition = -1;
    localSavedState.mSpanOffsetsSize = 0;
    label278: return localSavedState;
  }
