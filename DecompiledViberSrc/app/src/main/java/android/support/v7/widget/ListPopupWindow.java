  ...
  implements s
{
  ...
  private int buildDropDown()
  {
    ...
    while (true)
    {
      ...
      while (true)
      {
        label326: Drawable localDrawable = this.mPopup.getBackground();
        int i3;
        int m;
        ...
        while (true)
        {
          label390: if (this.mPopup.getInputMethodMode() == 2);
          int n;
          while (true)
          {
      ...
      label742: localObject = localDropDownListView;
      i8 = 0;
    }
  }
  ...
  public void show()
  {
    ...
    while (true)
    {
      ...
      label71: int i4;
      label93: int n;
      label111: PopupWindow localPopupWindow4;
      View localView;
      int i1;
      int i2;
      ...
      while (true)
      {
        ...
        label242: i4 = 0;
        break label93;
        label248: PopupWindow localPopupWindow5 = this.mPopup;
        if (this.mDropDownWidth == i);
        for (int i3 = i; ; i3 = 0)
        {
        ...
        label292: if (this.mDropDownHeight == -2)
        {
          n = j;
          break label111;
        }
      ...
      {
        k = i;
        label333: if (this.mDropDownHeight != i)
          break label563;
        j = i;
        label343: this.mPopup.setWidth(k);
      ...
      try
      {
        ...
        break label333;
        label563: if (this.mDropDownHeight == -2)
          break label343;
        j = this.mDropDownHeight;
        break label343;
        label580: bool1 = false;
      }
      catch (Exception localException)
      {
        while (true)
