  ...
  implements c
{
  ...
  View.OnKeyListener mTextKeyListener = new View.OnKeyListener()
  {
    public boolean onKey(View paramAnonymousView, int paramAnonymousInt, KeyEvent paramAnonymousKeyEvent)
    {
      ...
      while ((SearchView.this.mSearchSrcTextView.isEmpty()) || (!paramAnonymousKeyEvent.hasNoModifiers()) || (paramAnonymousKeyEvent.getAction() != 1) || (paramAnonymousInt != 66));
  ...
  private void updateViewsVisibility(boolean paramBoolean)
  {
    ...
    if (paramBoolean)
    {
      ...
      if ((this.mCollapsedIcon.getDrawable() != null) && (!this.mIconifiedByDefault))
        break label130;
      label85: this.mCollapsedIcon.setVisibility(i);
      updateCloseButton();
      if (bool2)
        break label135;
    }
    ...
    public boolean onTouchEvent(MotionEvent paramMotionEvent)
    {
      ...
      while (true)
      {
        ...
        if (!this.mTargetBounds.contains(i, j))
          break;
        this.mDelegateTargeted = bool1;
        bool2 = bool1;
        break label51;
        bool2 = this.mDelegateTargeted;
        if ((!bool2) || (this.mSlopBounds.contains(i, j)))
          break label51;
        bool1 = false;
        break label51;
        bool2 = this.mDelegateTargeted;
        ...
        break label51;
        label180: paramMotionEvent.setLocation(i - this.mActualBounds.left, j - this.mActualBounds.top);
      }
    }
