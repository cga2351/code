  ...
  implements DecorToolbar
{
  ...
  public ToolbarWidgetWrapper(Toolbar paramToolbar, boolean paramBoolean, int paramInt1, int paramInt2)
  {
    ...
    while (true)
    {
      ...
      {
        final android.support.v7.view.menu.a mNavItem = new android.support.v7.view.menu.a(ToolbarWidgetWrapper.this.mToolbar.getContext(), 0, 16908332, 0, 0, ToolbarWidgetWrapper.this.mTitle);
      ...
      bool = false;
      break;
      label492: this.mDisplayOpts = detectDisplayOptions();
    }
  }
  ...
  public void setMenu(Menu paramMenu, o.a parama)
  {
    ...
    this.mActionMenuPresenter.setCallback(parama);
  ...
  public ViewPropertyAnimatorCompat setupAnimatorToVisibility(final int paramInt, long paramLong)
  {
    ...
    for (float f = 1.0F; ; f = 0.0F)
      return localViewPropertyAnimatorCompat.alpha(f).setDuration(paramLong).setListener(new ViewPropertyAnimatorListenerAdapter()
      {
