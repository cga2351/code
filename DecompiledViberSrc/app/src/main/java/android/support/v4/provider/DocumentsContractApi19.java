...
class DocumentsContractApi19
{
  ...
  public static boolean exists(Context paramContext, Uri paramUri)
  {
    ...
    //   17: aconst_null
    //   18: aconst_null
    //   19: invokevirtual 72	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   22: astore 7
    //   24: aload 7
    //   26: astore 4
    //   28: aload 4
    ...
    //   43: istore 9
    //   45: aload 4
    //   47: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   50: iload 9
    //   52: ireturn
    //   53: iconst_0
    //   54: istore 9
    ...
    //   69: dup
    //   70: invokespecial 83	java/lang/StringBuilder:<init>	()V
    //   73: ldc 85
    //   75: invokevirtual 89	java/lang/StringBuilder:append	(Ljava/lang/String;)Ljava/lang/StringBuilder;
    //   78: aload 5
    //   80: invokevirtual 92	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   83: invokevirtual 96	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   86: invokestatic 102	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   89: pop
    //   90: aload 4
    //   92: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   95: iconst_0
    //   96: ireturn
    //   97: astore_3
    //   98: aconst_null
    //   99: astore 4
    //   101: aload 4
    //   103: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   106: aload_3
    //   107: athrow
    //   108: astore_3
    //   109: goto -8 -> 101
  ...
  private static long queryForLong(Context paramContext, Uri paramUri, String paramString, long paramLong)
  {
    ...
    //   18: aconst_null
    //   19: aconst_null
    //   20: invokevirtual 72	android/content/ContentResolver:query	(Landroid/net/Uri;[Ljava/lang/String;Ljava/lang/String;[Ljava/lang/String;Ljava/lang/String;)Landroid/database/Cursor;
    //   23: astore 10
    //   25: aload 10
    //   27: astore 7
    //   29: aload 7
    //   31: invokeinterface 140 1 0
    //   36: ifeq +32 -> 68
    //   39: aload 7
    //   41: iconst_0
    //   42: invokeinterface 144 2 0
    //   47: ifne +21 -> 68
    //   50: aload 7
    //   52: iconst_0
    ...
    //   58: lstore 11
    //   60: aload 7
    //   62: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   65: lload 11
    //   67: lreturn
    //   68: aload 7
    //   70: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   73: lload_3
    //   74: lreturn
    //   75: astore 8
    //   77: aconst_null
    ...
    //   94: aload 8
    //   96: invokevirtual 92	java/lang/StringBuilder:append	(Ljava/lang/Object;)Ljava/lang/StringBuilder;
    //   99: invokevirtual 96	java/lang/StringBuilder:toString	()Ljava/lang/String;
    //   102: invokestatic 102	android/util/Log:w	(Ljava/lang/String;Ljava/lang/String;)I
    //   105: pop
    //   106: aload 7
    //   108: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   111: lload_3
    //   112: lreturn
    //   113: astore 6
    //   115: aconst_null
    //   116: astore 7
    //   118: aload 7
    //   120: invokestatic 80	android/support/v4/provider/DocumentsContractApi19:closeQuietly	(Ljava/lang/AutoCloseable;)V
    //   123: aload 6
    //   125: athrow
    //   126: astore 6
    //   128: goto -10 -> 118
