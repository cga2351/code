  ...
  implements Collection<E>, Set<E>
{
  ...
  public <T> T[] toArray(T[] paramArrayOfT)
  {
    ...
    for (Object localObject = (Object[])Array.newInstance(paramArrayOfT.getClass().getComponentType(), this.mSize); ; localObject = paramArrayOfT)
    {
