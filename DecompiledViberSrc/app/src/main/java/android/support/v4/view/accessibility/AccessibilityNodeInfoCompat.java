...
public class AccessibilityNodeInfoCompat
{
  ...
  private boolean getBooleanProperty(int paramInt)
  {
    ...
    if (localBundle == null);
    while ((paramInt & localBundle.getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", 0)) != paramInt)
      return false;
    return true;
  }
  ...
  private void setBooleanProperty(int paramInt, boolean paramBoolean)
  {
    ...
    if (localBundle != null)
    {
      i = localBundle.getInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", 0) & (paramInt ^ 0xFFFFFFFF);
      if (!paramBoolean)
        break label37;
    }
    while (true)
    {
      localBundle.putInt("androidx.view.accessibility.AccessibilityNodeInfoCompat.BOOLEAN_PROPERTY_KEY", i | paramInt);
      return;
      label37: paramInt = 0;
    }
  }
  ...
  public boolean isHeading()
  {
    ...
    while ((localCollectionItemInfoCompat != null) && (localCollectionItemInfoCompat.isHeading()));
    return false;
  }
  ...
  public void setCollectionInfo(Object paramObject)
  {
    ...
    label25: for (AccessibilityNodeInfo.CollectionInfo localCollectionInfo = null; ; localCollectionInfo = (AccessibilityNodeInfo.CollectionInfo)((CollectionInfoCompat)paramObject).mInfo)
    {
  ...
  public void setCollectionItemInfo(Object paramObject)
  {
    ...
    label25: for (AccessibilityNodeInfo.CollectionItemInfo localCollectionItemInfo = null; ; localCollectionItemInfo = (AccessibilityNodeInfo.CollectionItemInfo)((CollectionItemInfoCompat)paramObject).mInfo)
    {
  ...
  public static class AccessibilityActionCompat
  {
    ...
    static
    {
      ...
      label326: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction3;
      label349: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction4;
      label372: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction5;
      label396: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction6;
      label421: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction7;
      label446: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction8;
      label471: AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction9;
      if (Build.VERSION.SDK_INT >= 23)
      {
        ...
        label496: ACTION_MOVE_WINDOW = new AccessibilityActionCompat(localAccessibilityAction9);
        if (Build.VERSION.SDK_INT < 28)
          break label616;
      }
      label571: label576: label581: label586: label592: label598: label604: label610: label616: for (AccessibilityNodeInfo.AccessibilityAction localAccessibilityAction10 = AccessibilityNodeInfo.AccessibilityAction.ACTION_SHOW_TOOLTIP; ; localAccessibilityAction10 = null)
      {
        ACTION_SHOW_TOOLTIP = new AccessibilityActionCompat(localAccessibilityAction10);
        ...
        ACTION_HIDE_TOOLTIP = new AccessibilityActionCompat(localAccessibilityAction11);
        return;
