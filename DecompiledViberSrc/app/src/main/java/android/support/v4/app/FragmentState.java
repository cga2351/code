  ...
  implements Parcelable
{
  ...
  public Fragment instantiate(FragmentHostCallback paramFragmentHostCallback, FragmentContainer paramFragmentContainer, Fragment paramFragment, FragmentManagerNonConfig paramFragmentManagerNonConfig, u paramu)
  {
    ...
    label249: for (this.mInstance = paramFragmentContainer.instantiate(localContext, this.mClassName, this.mArguments); ; this.mInstance = Fragment.instantiate(localContext, this.mClassName, this.mArguments))
    {
      ...
      this.mInstance.mViewModelStore = paramu;
