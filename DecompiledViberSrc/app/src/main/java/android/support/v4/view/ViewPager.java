...
public class ViewPager extends ViewGroup
{
      ...
      for (int k = 0; ; k = bool)
      {
        if (f2 < f3)
        {
          if (j == 0)
            break label266;
          float f7 = f3 - f2;
          this.mLeftEdge.onPull(Math.abs(f7) / i);
        }
        while (true)
        {
  ...
  void dataSetChanged()
  {
    ...
    while (true)
    {
      ...
      else if (localItemInfo.position != i5)
      {
  ...
  public boolean onTouchEvent(MotionEvent paramMotionEvent)
  {
    ...
    while (true)
    {
      ...
      {
        label396: for (float f6 = this.mInitialMotionX + this.mTouchSlop; ; f6 = this.mInitialMotionX - this.mTouchSlop)
        {
  ...
  {
    ItemInfo localItemInfo13;
    if (this.mCurItem != paramInt)
    {
      localItemInfo13 = infoForPosition(this.mCurItem);
      this.mCurItem = paramInt;
    }
    for (ItemInfo localItemInfo1 = localItemInfo13; ; localItemInfo1 = null)
    {
      if (this.mAdapter == null)
      ...
      while (true)
      {
        ...
        for (ItemInfo localItemInfo3 = addNewItem(this.mCurItem, n); ; localItemInfo3 = localItemInfo2)
        {
          ...
          if (localItemInfo3 != null)
          {
            ...
            if (i4 < 0)
              break label634;
            localItemInfo7 = (ItemInfo)this.mItems.get(i4);
            i5 = getClientWidth();
            if (i5 > 0)
              break label640;
            f1 = 0.0F;
            ...
            if (f3 < 2.0F)
            {
              if (i10 >= this.mItems.size())
                break label847;
              localItemInfo8 = (ItemInfo)this.mItems.get(i10);
              label441: if (i5 > 0)
                break label853;
            }
          }
          ...
          int i12;
          int i13;
          label640: label662: label847: label853: for (float f4 = 0.0F; ; f4 = 2.0F + getPaddingRight() / i5)
          {
            int i11 = 1 + this.mCurItem;
            ...
            calculatePageOffsets(localItemInfo3, i8, localItemInfo1);
            this.mAdapter.setPrimaryItem(this, this.mCurItem, localItemInfo3.object);
            this.mAdapter.finishUpdate(this);
            int i1 = getChildCount();
            for (int i2 = 0; i2 < i1; i2++)
            {
              View localView3 = getChildAt(i2);
              LayoutParams localLayoutParams = (LayoutParams)localView3.getLayoutParams();
              localLayoutParams.childIndex = i2;
            ...
            n++;
            break;
            label634: localItemInfo7 = null;
            break label333;
            f1 = 2.0F - localItemInfo3.widthFactor + getPaddingLeft() / i5;
            break label347;
            if ((i7 == localItemInfo7.position) && (!localItemInfo7.scrolling))
            {
              ...
              if (i9 < 0)
                break label736;
              localItemInfo7 = (ItemInfo)this.mItems.get(i9);
            }
            while (true)
            {
              i7--;
              break;
              label736: localItemInfo7 = null;
              continue;
              label742: if ((localItemInfo7 != null) && (i7 == localItemInfo7.position))
              {
          ...
          label869: ItemInfo localItemInfo12;
          label938: Object localObject2;
          float f6;
          if ((i13 == ((ItemInfo)localObject1).position) && (!((ItemInfo)localObject1).scrolling))
          {
            this.mItems.remove(i12);
            this.mAdapter.destroyItem(this, i13, ((ItemInfo)localObject1).object);
            if (i12 < this.mItems.size())
            {
              localItemInfo12 = (ItemInfo)this.mItems.get(i12);
              float f10 = f3;
              localObject2 = localItemInfo12;
              f6 = f10;
            }
          }
          while (true)
          {
            ...
            break label938;
            label974: if ((localObject1 != null) && (i13 == ((ItemInfo)localObject1).position))
            {
              float f8 = f3 + ((ItemInfo)localObject1).widthFactor;
              i12++;
              if (i12 < this.mItems.size());
              for (ItemInfo localItemInfo11 = (ItemInfo)this.mItems.get(i12); ; localItemInfo11 = null)
              {
                localObject2 = localItemInfo11;
                f6 = f8;
                break;
              }
            }
            ItemInfo localItemInfo9 = addNewItem(i13, i12);
            i12++;
            float f5 = f3 + localItemInfo9.widthFactor;
            if (i12 < this.mItems.size());
            for (ItemInfo localItemInfo10 = (ItemInfo)this.mItems.get(i12); ; localItemInfo10 = null)
            {
              localObject2 = localItemInfo10;
              f6 = f5;
              break;
            }
            sortChildDrawingOrder();
