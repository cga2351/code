...
public abstract class BaseTransientBottomBar<B extends BaseTransientBottomBar<B>>
{
  ...
  private final android.support.design.h.a contentViewCallback;
  ...
  static
  {
    ...
    for (boolean bool = true; ; bool = false)
    {
      ...
      arrayOfInt[0] = R.attr.snackbarStyle;
      SNACKBAR_STYLE_ATTR = arrayOfInt;
  ...
  protected BaseTransientBottomBar(ViewGroup paramViewGroup, View paramView, android.support.design.h.a parama)
  {
    ...
    this.contentViewCallback = parama;
  ...
  private void animateViewOut(final int paramInt)
  {
    ...
    arrayOfInt[0] = 0;
    arrayOfInt[1] = getTranslationYBottom();
  ...
  private int getTranslationYBottom()
  {
    ...
    if ((localLayoutParams instanceof ViewGroup.MarginLayoutParams))
      return i + ((ViewGroup.MarginLayoutParams)localLayoutParams).bottomMargin;
    return i;
  }
  ...
  void onViewHidden(int paramInt)
  {
    ...
    if (this.callbacks != null)
      for (int i = -1 + this.callbacks.size(); i >= 0; i--)
  ...
  final void showView()
  {
    CoordinatorLayout.LayoutParams localLayoutParams1;
    if (this.view.getParent() == null)
    {
      ViewGroup.LayoutParams localLayoutParams = this.view.getLayoutParams();
      if ((localLayoutParams instanceof CoordinatorLayout.LayoutParams))
      {
        localLayoutParams1 = (CoordinatorLayout.LayoutParams)localLayoutParams;
        if (this.behavior != null)
          break label128;
      }
    }
    label128: for (Object localObject = getNewBehavior(); ; localObject = this.behavior)
    {
      ...
      localLayoutParams1.setBehavior((CoordinatorLayout.Behavior)localObject);
    ...
    onViewShown();
    return;
    label141: this.view.setOnLayoutChangeListener(new OnLayoutChangeListener()
    {
  ...
  public static class BehaviorDelegate
  {
    ...
    public void onInterceptTouchEvent(CoordinatorLayout paramCoordinatorLayout, View paramView, MotionEvent paramMotionEvent)
    {
      ...
      case 0:
        do
          return;
        while (!paramCoordinatorLayout.isPointInChildBounds(paramView, (int)paramMotionEvent.getX(), (int)paramMotionEvent.getY()));
  ...
  @Deprecated
  public static abstract interface ContentViewCallback extends android.support.design.h.a
  {
  }
