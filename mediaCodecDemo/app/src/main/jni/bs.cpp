...
Java_com_dxtx_test_NativeUtils_testImg(JNIEnv *env, jclass type, jstring filepath_, jintArray data,
                                 jstring text_) {
...
Java_com_dxtx_test_NativeUtils_drawText(JNIEnv *env, jclass type, jbyteArray data_, jint w,
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dxtx_test_NativeUtils_fixTextArea(JNIEnv *env, jclass type, jstring text_) {
    //转为为宽字符,确定文字范围
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dxtx_test_NativeUtils_release(JNIEnv *env, jclass type) {
    if (&dxtx::bg != NULL) {
        dxtx::bg.release();
        dxtx::bg = NULL;
    }
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dxtx_test_NativeUtils_fixColorFormat(JNIEnv *env, jclass type, jint decodeColor,
                                        jint encodeColor) {
...
extern "C"
JNIEXPORT void JNICALL
Java_com_dxtx_test_NativeUtils_fixFontFile(JNIEnv *env, jclass type, jstring ttfPath_) {
